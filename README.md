...
The main goal of this project is to undeerstand how fundamental quantum-computing concepts can be represented using vectors, matrices, tensor products, probability calculations, and linear algebra.
...
A quatntum state can be represented using a Numpy array.
import numpy as np
